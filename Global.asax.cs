...
namespace WEB
{
    public class Global : System.Web.HttpApplication
    {
        ...
        protected void Application_Start(object sender, EventArgs e)
        {
            ...
            Posts.Add(new Post(2,"Máy tính chạy bằng tảo lục lam trong 6 tháng","nguyena",DateTime.Today,"Chuyên gia Christopher Howe tại Đại học Cambridge cùng các đồng nghiệp vận hành một máy tính trong 6 tháng với nguồn năng lượng là tảo lục lam. " +
            ...
            Categories.Add(new Category("Kháccccc"));
