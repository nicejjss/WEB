...
namespace WEB
{
    public class Global : System.Web.HttpApplication
    {
        ...
        protected void Application_Start(object sender, EventArgs e)
        {
            ...
            Posts.Add(new Post(1,0,"Mặt tối của những hệ thống siêu máy tính", "daoducloc",new DateTime(2022,03,12), "Kể từ năm 1964, thời điểm CDC 6600 – được xem như siêu máy tính đầu tiên trên thế giới – ra đời cho đến nay, một cuộc chạy đua được hình thành trong cộng đồng điện toán hiệu năng cao toàn cầu. " +
            ...
            Posts.Add(new Post(2,0,"Máy tính chạy bằng tảo lục lam trong 6 tháng","nguyena",DateTime.Now,"Chuyên gia Christopher Howe tại Đại học Cambridge cùng các đồng nghiệp vận hành một máy tính trong 6 tháng với nguồn năng lượng là tảo lục lam. " +
            ...
            Posts.Add(new Post(4,0,"Hai tư liệu Việt là di sản châu Á - Thái Bình Dương","daoducloc",new DateTime(2020,01,02), "Bia ma nhai (Đà Nẵng) và bộ sưu tập Văn bản Hán Nôm (Hà Tĩnh) được công nhận là Di sản tư liệu khu vực châu Á - Thái Bình Dương. " +
            ...
            Posts.Add(new Post(5,0, "Máy tính để bàn thiết kế tối giản của HP","daoducloc",new DateTime(2022,05,15), "HP M01 là mẫu máy tính để bàn doanh nghiệp mới với thiết kế tối giản, nhỏ gọn, tập trung vào hiệu năng và khả năng vận hành. " +
            ...
            Posts.Add(new Post(6,0, "Bộ phim Việt Huyền Sử Vua Đinh rút khỏi rạp với doanh thu 42 triệu đồng","tranb",new DateTime(2022,11,29), "Trao đổi với Tiền Phong, đạo diễn Anthony Võ cho biết anh bình thản đối diện trước thực tế bộ phim Huyền Sử Vua Đinh rút khỏi rạp chiếu. Đây là tình huống mà ê-kíp đã lường trước khi bộ phim không đạt doanh thu như kỳ vọng. " +
